...
requirements = python3,cryptography,imageio,jnius,kivy,kivymd,mutagen,pillow,plyer,psutil,pygame,bcrypt,qrcode,requests
...
# This property takes a dictionary of key-value pairs.
...
# (str) argument for --private-data-dir, if omitted defaults to the location of main.py
# (bool) pass --private-data-dir to p4a (default: False)
#p4a.private_data_dir = /path/to/the/private-data-dir
#p4a.private_data_dir_set = True
